...
export class AddTenantIsolationAndEnrollments1784175065080 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "academic_years" ADD CONSTRAINT "FK_ay_tenant" FOREIGN KEY ("tenant_id") REFERENCES "schools"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );

    // 2. Add tenant_id to classes
    await queryRunner.query(`ALTER TABLE "classes" ADD "tenant_id" uuid`);
    await queryRunner.query(
      `ALTER TABLE "classes" ADD CONSTRAINT "FK_cl_tenant" FOREIGN KEY ("tenant_id") REFERENCES "schools"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );

    // 3. Add tenant_id and capacity to class_sections
    await queryRunner.query(`ALTER TABLE "class_sections" ADD "tenant_id" uuid`);
    await queryRunner.query(
      `ALTER TABLE "class_sections" ADD CONSTRAINT "FK_cs_tenant" FOREIGN KEY ("tenant_id") REFERENCES "schools"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "teachers" ADD CONSTRAINT "FK_tch_tenant" FOREIGN KEY ("tenant_id") REFERENCES "schools"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );

    // 5. Add tenant_id to guardians
    await queryRunner.query(`ALTER TABLE "guardians" ADD "tenant_id" uuid`);
    await queryRunner.query(
      `ALTER TABLE "guardians" ADD CONSTRAINT "FK_grd_tenant" FOREIGN KEY ("tenant_id") REFERENCES "schools"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );

    // 6. Add tenant_id to fee_structures
    await queryRunner.query(`ALTER TABLE "fee_structures" ADD "tenant_id" uuid`);
    await queryRunner.query(
      `ALTER TABLE "fee_structures" ADD CONSTRAINT "FK_fs_tenant" FOREIGN KEY ("tenant_id") REFERENCES "schools"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );

    // 6b. Add tenant_id to students
    await queryRunner.query(`ALTER TABLE "students" ADD "tenant_id" uuid`);
    await queryRunner.query(
      `ALTER TABLE "students" ADD CONSTRAINT "FK_st_tenant" FOREIGN KEY ("tenant_id") REFERENCES "schools"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );

    // 7. Add tenant_id to payments
    await queryRunner.query(`ALTER TABLE "payments" ADD "tenant_id" uuid`);
    await queryRunner.query(
      `ALTER TABLE "payments" ADD CONSTRAINT "FK_pay_tenant" FOREIGN KEY ("tenant_id") REFERENCES "schools"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );

    // 8. Add deleted_at to academic_years for soft delete
    await queryRunner.query(
      `ALTER TABLE "academic_years" ADD "deleted_at" TIMESTAMP WITH TIME ZONE`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "class_sections" ADD "deleted_at" TIMESTAMP WITH TIME ZONE`,
    );

    // 11. Add deleted_at to fee_structures for soft delete
    await queryRunner.query(
      `ALTER TABLE "fee_structures" ADD "deleted_at" TIMESTAMP WITH TIME ZONE`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "teacher_class_sections" ADD CONSTRAINT "FK_tcs_teacher" FOREIGN KEY ("teacher_id") REFERENCES "teachers"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "teacher_class_sections" ADD CONSTRAINT "FK_tcs_section" FOREIGN KEY ("section_id") REFERENCES "class_sections"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );

    // 18. Create enrollments table
    await queryRunner.query(
      `CREATE TYPE "public"."enrollments_status_enum" AS ENUM('ACTIVE', 'INACTIVE', 'TRANSFERRED', 'GRADUATED')`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "enrollments" ADD CONSTRAINT "FK_enr_student" FOREIGN KEY ("student_id") REFERENCES "students"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "enrollments" ADD CONSTRAINT "FK_enr_class" FOREIGN KEY ("class_id") REFERENCES "classes"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "enrollments" ADD CONSTRAINT "FK_enr_section" FOREIGN KEY ("section_id") REFERENCES "class_sections"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "enrollments" ADD CONSTRAINT "FK_enr_academic_year" FOREIGN KEY ("academic_year_id") REFERENCES "academic_years"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "enrollments" ADD CONSTRAINT "FK_enr_tenant" FOREIGN KEY ("tenant_id") REFERENCES "schools"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_enr_active_student_year" ON "enrollments" ("student_id", "academic_year_id") WHERE enrollment_status = 'ACTIVE'`,
    );
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_ay_name_tenant" ON "academic_years" ("name", "tenant_id") WHERE "deleted_at" IS NULL`,
    );
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_cs_name_class" ON "class_sections" ("class_id", "section_name") WHERE "deleted_at" IS NULL`,
    );
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_ay_is_current_tenant" ON "academic_years" ("is_current", "tenant_id") WHERE is_current = true AND "deleted_at" IS NULL`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "teacher_class_sections" DROP CONSTRAINT "FK_tcs_section"`,
    );
    await queryRunner.query(
      `ALTER TABLE "teacher_class_sections" DROP CONSTRAINT "FK_tcs_teacher"`,
    );
