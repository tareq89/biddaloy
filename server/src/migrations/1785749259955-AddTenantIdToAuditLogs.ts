...
export class AddTenantIdToAuditLogs1785749259955 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "audit_logs" ADD CONSTRAINT "FK_al_tenant" FOREIGN KEY ("tenant_id") REFERENCES "schools"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
