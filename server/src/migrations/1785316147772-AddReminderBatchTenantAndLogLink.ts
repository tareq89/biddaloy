...
export class AddReminderBatchTenantAndLogLink1785316147772 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "reminder_batches" ADD CONSTRAINT "FK_rb_tenant" FOREIGN KEY ("tenant_id") REFERENCES "schools"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "communication_logs" ADD CONSTRAINT "FK_cml_reminder_batch" FOREIGN KEY ("reminder_batch_id") REFERENCES "reminder_batches"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`CREATE INDEX "IDX_cml_reminder_batch" ON "communication_logs" ("reminder_batch_id")`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX "public"."IDX_cml_reminder_batch"`);
        await queryRunner.query(`ALTER TABLE "communication_logs" DROP CONSTRAINT "FK_cml_reminder_batch"`);
