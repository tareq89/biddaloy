...
export class AddResultSmsCommunicationTrigger1789800012500 implements MigrationInterface {
  name = 'AddResultSmsCommunicationTrigger1789800012500';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TYPE "public"."communication_logs_trigger_enum" ADD VALUE 'RESULT_SMS'`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    // already uses 'RESULT_SMS': rolling back into data the old type
