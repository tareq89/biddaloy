...
export const UI_ONLY_PERMISSIONS: Permission[] = [
  ...
  // PAYMENT_REVERSE now gates `POST /payments/:id/reverse` (16.6.1), so
  // it's no longer UI-only — removed from this list.
  // REPORT_COLLECTIONS_READ, SCHEDULE_MANAGE and DISCOUNT_RULE_MANAGE gate
  // the collections report and the recurring schedule / discount rule
  // management endpoints (16.3.x/16.4.x).
