...
## Corpus Check
- 1007 files · ~548,032 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5708 nodes · 15596 edges · 277 communities (218 shown, 59 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 296 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d1eabb52`
...
## Communities (277 total, 59 thin omitted)

### Community 0 - "app.module.ts"
Cohesion: 0.03
Nodes (74): worker, wsPassthrough, classDefaultHandlers, communicationDefaultHandlers, getBulkReminder, getBulkReminderLogs, getOne, lastReminders (+66 more)
...
### Community 3 - "Student"
Cohesion: 0.07
Nodes (46): SanitizeAllowlist(), SanitizeText(), shared, AllowlistDto, { sanitizeAllowlist, sanitizeStrict }, StrictDto, CreateAcademicYearDto, IsBeforeConstraint (+38 more)
...
Cohesion: 0.07
Nodes (34): @nestjs/swagger, ApiTenantAuth(), TestController, requestContext, paginatedSchema(), AuditInterceptor, RequestWithTenant, Injectable (+26 more)

### Community 6 - "StudentService"
Cohesion: 0.06
Nodes (57): ApiHideProperty, RecordAuditEntryInput, AuditLogListResponseDto, AuditLogResponseDto, ApiProperty, AuditLog, Column, CreateDateColumn (+49 more)

### Community 7 - "routeTree.gen.ts"
Cohesion: 0.03
Nodes (91): leafPaths(), normalize(), router, buildLoginError(), LoginPage(), loginSearchSchema, Route, Route (+83 more)

### Community 8 - "classes.ts"
Cohesion: 0.06
Nodes (51): AcademicYearService, AcademicYearStats, Injectable, InjectRepository, AcademicYear, Column, CreateDateColumn, DeleteDateColumn (+43 more)

### Community 9 - "School"
Cohesion: 0.05
Nodes (66): DeleteYearDialog(), DeleteYearDialogProps, SetCurrentDialog(), SetCurrentDialogProps, EMPTY_VALUES, YearFormDialog(), YearFormDialogProps, YearFormInitialValues (+58 more)
...
Cohesion: 0.08
Nodes (25): KLASS, paisaRegionHandler(), referenceHandlers(), render(), YEAR, FeeApplicability, FeeType, FeeStructure (+17 more)

### Community 12 - "Roles"
Cohesion: 0.05
Nodes (48): AcademicYearController, ApiOperation, ApiTags, Body, Controller, Delete, Get, Inject (+40 more)
...
Cohesion: 0.11
Nodes (18): toFamilyFeeStructure(), toFamilyPayment(), FeeController, ApiExtraModels, ApiOkResponse, ApiOperation, ApiTags, Controller (+10 more)
...
Cohesion: 0.07
Nodes (50): CreateFeeStructureDto, CreatePaymentDto, FamilyDueEntryDto, FamilyFeeStructureDto, FamilyPaymentAllocationDto, FamilyPaymentDto, FamilyStudentDueDto, FeeDuesSortBy (+42 more)
...
Cohesion: 0.06
Nodes (90): AcademicYearsListPage(), shortEntityId(), AuditLogFilters, AuditLogsList(), AuditLogsPage(), auditLogsSearchSchema, ENTITY_TYPES, FILTER_KEYS (+82 more)
...
Cohesion: 0.15
Nodes (13): PaginatedAuditEntries, renderAuditLogs(), AuditAction, AuditEntry, auditLogDefaultHandlers, auditLogHandlers, fixtures, list (+5 more)
...
Cohesion: 0.06
Nodes (74): TAB_IDS, ClassesTab(), ClassesTabProps, FeeStructuresTab(), FeeStructuresTabProps, TabQueryState(), TabQueryStateProps, TAB_IDS (+66 more)
...
Cohesion: 0.07
Nodes (37): subscribeAuthState(), AppShell(), AppShellNavItem, AppShellProps, NavContent(), NavGroupSection(), readGroupCollapsed(), Default (+29 more)
...
Cohesion: 0.26
Nodes (10): NumeralSystem, formatAcademicYear(), formatDateTime(), getAcademicYear(), julyStart, julyStartBn, renderDigits(), toLatinDigits() (+2 more)

### Community 47 - "router-integration.test.tsx"
Cohesion: 0.19
Nodes (11): formatGuardianPhone(), formatValidPhone(), PhoneInputProps, REGION_BD_EN, REGION_FIXTURE, detectLoginIdentifier(), emailSchema, LoginIdentifier (+3 more)
...
Cohesion: 0.04
Nodes (56): buildRateLimitTracker(), escapeLikePattern(), AcademicYearModule, Module, ClassSection, Column, CreateDateColumn, DeleteDateColumn (+48 more)
...
Cohesion: 0.06
Nodes (53): LabelProps, RadioGroupItemProps, RadioGroupProps, SelectContentProps, SelectGroupProps, SelectItemProps, SelectLabelProps, SelectProps (+45 more)
...
Cohesion: 0.03
Nodes (179): AcademicYearDetailPage(), ClassDetailPage(), SectionFormDialog(), BatchDetail(), batchDetailSearchSchema, buildRetryName(), BulkReminderWizard(), SKIP_REASON_KEYS (+171 more)
...
Cohesion: 0.26
Nodes (8): addressForMedium(), DISPATCHABLE_MEDIA, selectReminderGuardians(), formatDueAmount(), SkipReason, guardian(), student(), StudentDueSnapshot

### Community 69 - "index.ts"
Cohesion: 0.20
Nodes (14): ChildSummary, CommunicationTrigger, FeeStatus, PaymentAllocationType, PaymentMethod, PaymentStatus, ROLE_PERMISSIONS, FeeLineItem (+6 more)
...
Cohesion: 0.05
Nodes (39): DataTable(), DataTableProps, DataTableSort, readPersistedState(), COLUMNS, Default, Empty, ErrorState (+31 more)
...
Cohesion: 0.10
Nodes (33): StudentSearch(), StudentSearchProps, FeeStructureStudentPicker(), FeeStructureStudentPickerProps, EditGuardianDialog(), EditGuardianDialogProps, FormState, PREFERRED_COMMUNICATION_OPTIONS (+25 more)
...
Cohesion: 0.16
Nodes (10): EMPTY_PAGE, PaymentForm(), useCreatePayment(), renderHookWithProviders(), RenderHookWithProvidersOptions, RenderHookWithProvidersResult, createTestQueryClient(), renderWithProviders() (+2 more)
...
Cohesion: 0.11
Nodes (18): AppShellNavGroup, navGroups, navItems, items, SkipLink(), SkipLinkProps, Default, meta (+10 more)
...
Cohesion: 0.06
Nodes (25): Route, RootLayout(), RouterContext, GUARDIAN_ROLES, isGuardianRole(), isStaffRole(), STAFF_ROLES, ensureSessionLoaded() (+17 more)
...
Cohesion: 0.10
Nodes (25): createAppQueryClient(), handleGlobalQueryError(), createI18nInstance(), i18n, whenReady(), DocumentLocaleSync(), I18nProvider(), I18nProviderProps (+17 more)

### Community 106 - "db.helper.ts"
Cohesion: 0.06
Nodes (31): JoinTable, createStudentEnrolledIn(), EnrollmentService, Injectable, InjectRepository, InjectRepository, InjectRepository, Enrollment (+23 more)
...
Cohesion: 0.21
Nodes (7): GlobalSearchLauncher(), flatten(), GlobalSearch(), GlobalSearchGroup, GROUPS, TEACHER_SEARCH_ROLES, useGlobalSearch()
...
Cohesion: 0.36
Nodes (5): CurrencyGrouping, minorUnitsToDecimalString(), groupDigits(), groupLakhCrore(), groupThousand()
...
Cohesion: 0.10
Nodes (18): RegionalFormValues, regionalSchema, RegionalSectionProps, RegionConfig, ConnectionTestResult, MaskedCommunicationsSettings, MaskedGreenwebSmsSettings, MaskedMimSmsSettings (+10 more)
...
Cohesion: 0.13
Nodes (28): AllocateStepProps, AllocationLine, AllocationSummary, AllocationType, applyLineEdit(), classifyAllocationType(), OutstandingFee, prefillFifoAllocations() (+20 more)
...
Cohesion: 0.11
Nodes (12): SchoolSettingsPage(), Route, SelectSchoolPage(), selectSchoolSearchSchema, getAccessToken(), getActiveRole(), getActiveTenant(), dualRoleOneSchool (+4 more)
...
Cohesion: 0.04
Nodes (51): Default, meta, RightToLeft, Story, CustomRetryLabel, Default, meta, RightToLeft (+43 more)
...
Cohesion: 0.17
Nodes (25): EmailConfig, EmailFormValues, emailSchema, EmailSection(), EmailSectionProps, MessengerSection(), RegionalSection(), SmsSection() (+17 more)

### Community 180 - "enrollments.ts"
Cohesion: 0.07
Nodes (24): AuditService, Injectable, InjectRepository, CommunicationLog, Column, CreateDateColumn, Entity, Index (+16 more)
...
Cohesion: 0.15
Nodes (14): authDefaultHandlers, login, loginInvalidCredentials, loginRateLimited, loginResponseFactory(), logout, logoutAll, refresh (+6 more)
...
Cohesion: 0.04
Nodes (58): StatisticsTab(), StatisticsTabProps, ClassesCountCell(), StudentsCountCell(), BULK_MEDIUMS, BulkMedium, RecipientFilters, STEP_IDS (+50 more)
...
Cohesion: 0.38
Nodes (10): bootstrap(), clearScheduledRefresh(), decodeAccessTokenMemberships(), decodeAccessTokenSubject(), decodeBase64UrlToString(), decodeJwt(), decodeJwtExpiryMs(), quietRefresh() (+2 more)
...
### Community 316 - "date-picker.test.tsx"
Cohesion: 0.27
Nodes (5): LOCALE_REGION_DEFAULTS, RegionConfigContext, REGION_BD_BN, compilePattern(), resolveRegionConfig()
...
- **Why does `fee()` connect `support.ts` to `HealthModule`, `smtp-email.provider.ts`, `Payment`?**
  _High betweenness centrality (0.094) - this node is a cross-community bridge._
- **Why does `payment()` connect `HealthModule` to `Payment`, `support.ts`?**
  _High betweenness centrality (0.062) - this node is a cross-community bridge._
- **Why does `DiffPanel()` connect `rtl-decorator.tsx` to `app-shell.stories.tsx`, `dialog.tsx`, `HealthModule`, `payments-tab.tsx`?**
