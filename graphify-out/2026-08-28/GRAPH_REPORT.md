...
## Corpus Check
- 1009 files · ~550,166 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5717 nodes · 15614 edges · 309 communities (232 shown, 77 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 296 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `05c8ae2b`
...
## Communities (309 total, 77 thin omitted)

### Community 0 - "app.module.ts"
Cohesion: 0.02
Nodes (89): worker, wsPassthrough, academicYearDefaultHandlers, academicYearHandlers, create, fixtures, getOne, list (+81 more)

### Community 1 - "User"
Cohesion: 0.09
Nodes (47): SelectSchoolPage(), JwtMembership, JwtPayload, LoginResponse, clearAuthState(), currentSessionGeneration(), listeners, notifyAuthStateChange() (+39 more)

### Community 2 - "ClassController"
Cohesion: 0.08
Nodes (37): ApiBody, ApiConsumes, CurrentTenant, CurrentUser, TestController, Roles(), FeeController, ApiExtraModels (+29 more)
...
Cohesion: 0.08
Nodes (19): AuditInterceptor, RequestWithTenant, Injectable, AuditService, RecordAuditEntryInput, Injectable, InjectRepository, AuditLogListResponseDto (+11 more)

### Community 7 - "routeTree.gen.ts"
Cohesion: 0.03
Nodes (86): Route, buildLoginError(), LoginPage(), loginSearchSchema, Route, Route, Route, Route (+78 more)

### Community 8 - "classes.ts"
Cohesion: 0.06
Nodes (72): AcademicYearStats, InjectRepository, AcademicYear, Column, CreateDateColumn, DeleteDateColumn, Entity, Index (+64 more)

### Community 9 - "School"
Cohesion: 0.07
Nodes (60): GlobalSearchLauncher(), DeleteYearDialogProps, SetCurrentDialogProps, EMPTY_VALUES, YearFormDialogProps, YearFormInitialValues, ClassFormDialogProps, ClassFormInitialValues (+52 more)
...
Cohesion: 0.07
Nodes (25): KLASS, PRIOR_KLASS, PRIOR_YEAR, render(), SECTION, YEAR, AcademicYear, createStructure (+17 more)
...
Cohesion: 0.17
Nodes (5): Inject, FeeStructureService, PaymentService, Injectable, InjectRepository
...
Cohesion: 0.07
Nodes (52): paginatedSchema(), CreateFeeStructureDto, CreatePaymentDto, FamilyDueEntryDto, FamilyFeeStructureDto, FamilyPaymentAllocationDto, FamilyPaymentDto, FamilyStudentDueDto (+44 more)
...
Cohesion: 0.04
Nodes (94): AcademicYearsListPage(), ClassesListPage(), ClassFilters, ReminderHistoryList(), DeleteStructureDialog(), FeeStructureFilters, FeeStructuresListPage(), feeStructuresSearchSchema (+86 more)

### Community 20 - "students.controller.ts"
Cohesion: 0.10
Nodes (29): SectionFormDialog(), PromoteTeacherDialog(), TeacherDesignation, Class, classesQueryOptions(), classKeys, ClassListFilters, classQueryOptions() (+21 more)

### Community 21 - "Payment"
Cohesion: 0.05
Nodes (59): Check, AuditModule, Module, FamilyStudentFeeDto, PaymentAllocation, Column, CreateDateColumn, Entity (+51 more)

### Community 22 - "index.ts"
Cohesion: 0.05
Nodes (37): adminOwnSchool, CONFIGURED_EMAIL, twoSchools, PaginatedAuditEntries, renderAuditLogs(), render(), render(), dueRow() (+29 more)

### Community 23 - "app-shell.tsx"
Cohesion: 0.11
Nodes (38): ConnectionTestResultMessage(), ConnectionTestResultMessageProps, MutationErrorMessage(), SecretField(), SecretFieldProps, EmailConfig, EmailFormValues, emailSchema (+30 more)
...
Cohesion: 0.04
Nodes (100): balanceOf(), BreakdownCard(), deriveMonthStatus(), FeesHeader(), feesSearchSchema, FeesSummary(), InvoicesCard(), PaymentStatusValue (+92 more)

### Community 32 - "users.controller.ts"
Cohesion: 0.10
Nodes (18): ButtonBaseProps, ButtonProps, Default, Disabled, Error, IconOnly, Loading, meta (+10 more)
...
Cohesion: 0.16
Nodes (18): NewStudentPage(), Route, fieldId(), buildCreatePayload(), buildStudentFormSchema(), buildUpdatePayload(), defaultStudentFormValues(), PREFERRED_COMMUNICATION_VALUES (+10 more)
...
Cohesion: 0.10
Nodes (21): Route, AppShell(), AppShellProps, NavContent(), NavGroupSection(), readGroupCollapsed(), Default, Grouped (+13 more)
...
Cohesion: 0.12
Nodes (19): apiClient, BulkUploadError, BulkUploadResult, BulkUploadStudentsInput, useBulkUploadStudents(), FeeDuesFilters, feeDuesKeys, feeDuesQueryOptions() (+11 more)

### Community 47 - "router-integration.test.tsx"
Cohesion: 0.05
Nodes (54): isRealCalendarDate(), InformationTab(), InformationTabProps, EditGuardianDialogProps, formatGuardianPhone(), GuardianFilters, GuardiansListPage(), guardiansSearchSchema (+46 more)
...
Cohesion: 0.03
Nodes (78): ApiHideProperty, FailOpenThrottlerStorage, Injectable, buildRateLimitTracker(), AcademicYearModule, Module, TeacherClassSection, Column (+70 more)
...
Cohesion: 0.08
Nodes (35): LabelProps, RadioGroupItemProps, RadioGroupProps, TableBodyProps, TableCaptionProps, TableCellProps, TableFooter(), TableFooterProps (+27 more)
...
Cohesion: 0.11
Nodes (24): AddUserDialog(), LoginHistoryTab(), LoginHistoryTabProps, MembershipsTab(), MembershipsTabProps, groupPermissions(), PermissionsTab(), PermissionsTabProps (+16 more)
...
Cohesion: 0.08
Nodes (41): PortalFees(), OutstandingFeesStepProps, TransferStatusDialogProps, CreateEnrollmentInput, Enrollment, enrollmentKeys, UpdateEnrollmentInput, useCreateEnrollment() (+33 more)
...
Cohesion: 0.12
Nodes (25): ChildSummary, CommunicationStatus, CommunicationTrigger, FeeStatus, PaymentAllocationType, PaymentMethod, PaymentStatus, ReminderBatchStatus (+17 more)
...
Cohesion: 0.09
Nodes (27): StudentSearchProps, FeeStructureStudentPickerProps, FormState, StudentPickerProps, FindStudentStepProps, StudentFormProps, GlobalSearchEntityResult, GlobalSearchResults (+19 more)
...
Cohesion: 0.14
Nodes (16): CreateFeeStructureInput, feeStructureKeys, FeeStructureListFilters, feeStructureQueryOptions(), feeStructuresQueryOptions(), FeeStructureStudent, PaginatedFeeStructures, UpdateFeeStructureInput (+8 more)
...
Cohesion: 0.14
Nodes (13): navGroups, navItems, items, SkipLink(), SkipLinkProps, ActivationKey, BUTTON_KEYS, describeElement() (+5 more)
...
Cohesion: 0.12
Nodes (18): createI18nInstance(), i18n, whenReady(), DocumentLocaleSync(), I18nProvider(), I18nProviderProps, clearPersistedLocale(), getPersistedLocale() (+10 more)
...
Cohesion: 0.05
Nodes (38): CommunicationsService, toResponseDto(), Injectable, InjectQueue, InjectRepository, CommunicationResponseDto, CommunicationLog, Column (+30 more)
...
Cohesion: 0.09
Nodes (43): BatchDetail(), buildRetryName(), RecipientListProps, BulkPreviewSkipped, BulkPreviewStudent, BulkReminderPreview, collectFailedStudentIds(), PaginatedReminderBatches (+35 more)
...
Cohesion: 0.10
Nodes (35): AllocateStep(), AllocateStepProps, ALLOCATION_TYPE_KEY, AllocationLine, AllocationSummary, AllocationType, applyLineEdit(), classifyAllocationType() (+27 more)
...
Cohesion: 0.23
Nodes (7): AppModule, Module, createFee(), monthOffset(), buildHelmetOptions(), createApp(), createApp()
...
Cohesion: 0.13
Nodes (16): selectSchoolSearchSchema, UserRole, ROLE_PERMISSIONS, PersistedTenant, optionKey(), SchoolCard(), SchoolPicker(), SchoolPickerOption (+8 more)
...
Cohesion: 0.04
Nodes (43): Default, meta, RightToLeft, Story, CustomRetryLabel, Default, meta, RightToLeft (+35 more)
...
Cohesion: 0.20
Nodes (8): createAppQueryClient(), handleGlobalQueryError(), Default, ErrorVariant, meta, Story, SuccessVariant, Toaster()
...
Cohesion: 0.10
Nodes (25): CommunicationsController, ApiOkResponse, ApiOperation, ApiTags, Body, Controller, Get, HttpCode (+17 more)
...
Cohesion: 0.04
Nodes (87): AcademicYearDetailPage(), TAB_IDS, DeleteYearDialog(), ClassesTab(), SetCurrentDialog(), YearFormDialog(), YearFormPayload, AuditLogsPage() (+79 more)
...
Cohesion: 0.31
Nodes (6): StaffInvoiceDto, TeacherListResponseDto, TeacherResponseDto, ApiProperty, ApiProperty, UserResponseDto
...
Cohesion: 0.47
Nodes (4): countSmsSegments(), GSM7_ASCII_EXTENSION_SET, SmsEncoding, SmsSegmentInfo

### Community 246 - "jsdom"
Cohesion: 0.53
Nodes (5): decodeResidualEntitiesForPlainText(), normalize(), RESIDUAL_ENTITIES, sanitizeAllowlist(), sanitizeStrict()

### Community 252 - "route-manifest.test.ts"
Cohesion: 0.67
Nodes (3): leafPaths(), normalize(), router

### Community 254 - "component-boundary.spec.mjs"
Cohesion: 0.50
...
### Community 303 - "@tanstack/react-table"
Cohesion: 0.32
...
## Knowledge Gaps
- **1388 isolated node(s):** `semi`, `singleQuote`, `trailingComma`, `printWidth`, `prettier-plugin-tailwindcss` (+1383 more)
...
- **Why does `fee()` connect `fees.test.tsx` to `smtp-email.provider.ts`, `Payment`, `payments-tab.tsx`?**
