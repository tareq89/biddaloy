...
## Corpus Check
- 727 files · ~334,334 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4303 nodes · 10179 edges · 254 communities (184 shown, 70 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 167 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `82d783c1`
...
Cohesion: 0.04
Nodes (77): ApiHideProperty, AcademicYearModule, Module, TeacherClassSection, Column, CreateDateColumn, Entity, JoinColumn (+69 more)

### Community 5 - "Server Modules Fees"
Cohesion: 0.10
Nodes (47): SelectSchoolPage(), UserRole, JwtMembership, JwtPayload, LoginResponse, clearAuthState(), currentSessionGeneration(), getAccessToken() (+39 more)
...
Cohesion: 0.06
Nodes (63): GlobalSearchLauncher(), SecretFieldProps, SchoolSettingsPage(), EmailSectionProps, MessengerSectionProps, RegionalSectionProps, SmsSectionProps, WhatsAppSectionProps (+55 more)
...
Cohesion: 0.06
Nodes (33): CommunicationsService, toResponseDto(), Injectable, InjectQueue, InjectRepository, CommunicationResponseDto, InjectQueue, InjectRepository (+25 more)
