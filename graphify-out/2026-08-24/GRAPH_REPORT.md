...
## Corpus Check
- 836 files · ~406,815 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4848 nodes · 12430 edges · 271 communities (196 shown, 75 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 221 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `306bb065`
...
Cohesion: 0.04
Nodes (67): ApiHideProperty, buildRateLimitTracker(), AcademicYearModule, Module, TeacherClassSection, Column, CreateDateColumn, Entity (+59 more)

### Community 1 - "User"
Cohesion: 0.13
Nodes (19): UserRole, JwtMembership, JwtPayload, clearPersistedTenant(), getPersistedTenant(), PersistedTenant, persistTenant(), toRole() (+11 more)
...
### Community 3 - "Student"
Cohesion: 0.11
Nodes (29): ClassFormDialog(), ClassFormDialogProps, ClassFormInitialValues, EMPTY_VALUES, SectionFormDialog(), TeacherDesignation, Class, classKeys (+21 more)

### Community 4 - "index.ts"
Cohesion: 0.14
Nodes (45): CommunicationMedium, academicYearFactory(), auditEntryFactory(), BD_MOBILE_PREFIXES, BN_DISTRICTS, BN_FEMALE_FIRST_NAMES, BN_LAST_NAMES, BN_MALE_FIRST_NAMES (+37 more)
...
Cohesion: 0.06
Nodes (74): ClassesCountCell(), StudentsCountCell(), OutstandingFeesStepProps, apiClient, AcademicYear, academicYearKeys, AcademicYearListFilters, academicYearQueryOptions() (+66 more)

### Community 9 - "School"
Cohesion: 0.06
Nodes (70): AcademicYearStats, InjectRepository, AcademicYear, Column, CreateDateColumn, DeleteDateColumn, Entity, Index (+62 more)

### Community 10 - "rtl-decorator.tsx"
Cohesion: 0.14
Nodes (11): GlobalSearchLauncher(), FindStudentStep(), FindStudentStepProps, Route, flatten(), GlobalSearch(), GlobalSearchGroup, GROUPS (+3 more)
...
Cohesion: 0.10
Nodes (40): SelectSchoolPage(), selectSchoolSearchSchema, LoginResponse, clearAuthState(), currentSessionGeneration(), listeners, notifyAuthStateChange(), notifySessionExpired() (+32 more)

### Community 14 - "support.ts"
Cohesion: 0.03
Nodes (73): AuditEntry, Invoice, worker, wsPassthrough, auditLogDefaultHandlers, auditLogHandlers, fixtures, list (+65 more)
...
Cohesion: 0.21
Nodes (14): fieldId(), TransferDialog(), TransferDialogProps, classesQueryOptions(), useClasses(), CreateEnrollmentInput, Enrollment, enrollmentKeys (+6 more)

### Community 17 - "all-entities.ts"
Cohesion: 0.22
Nodes (8): CommunicationProvider, CommunicationProviderRegistry, CommunicationProviderRegistryService, Injectable, SmsProviderFactory, Injectable, Injectable, WhatsAppCloudProvider

### Community 18 - "index.ts"
Cohesion: 0.11
Nodes (23): AcademicYearsListPage(), Calendar(), CalendarProps, DatePicker(), DatePickerProps, daysInMonth(), sameDay(), formatAcademicYear() (+15 more)

### Community 19 - "dialog.tsx"
Cohesion: 0.08
Nodes (46): DeleteYearDialogProps, SetCurrentDialogProps, EMPTY_VALUES, YearFormDialogProps, YearFormInitialValues, DeleteClassDialog(), DeleteClassDialogProps, DeleteSectionDialog() (+38 more)
...
Cohesion: 0.10
Nodes (21): adminOwnSchool, CONFIGURED_EMAIL, twoSchools, routeTree, classFactory(), classSectionFactory(), authHandlers, create (+13 more)

### Community 23 - "app-shell.tsx"
Cohesion: 0.09
Nodes (24): AppShellNavGroup, AppShellNavItem, AppShellProps, NavContent(), NavGroupSection(), readGroupCollapsed(), navGroups, navItems (+16 more)
...
### Community 25 - "cn"
Cohesion: 0.07
Nodes (35): Label(), LabelProps, TableBodyProps, TableCaptionProps, TableCellProps, TableFooter(), TableFooterProps, TableHeaderProps (+27 more)

### Community 26 - "outbound-destination-guard.ts"
Cohesion: 0.09
Nodes (33): ResolvedGreenwebSmsConfig, ResolvedMimSmsConfig, CommunicationSendResult, assertResolvesToPublicAddress(), assertSafeHttpDestination(), assertSafeSmtpDestination(), DestinationBlockedError, DestinationResolutionError (+25 more)

### Community 27 - "fees.ts"
Cohesion: 0.14
Nodes (19): SchoolSettingsPage(), ROLE_PERMISSIONS, getAccessToken(), getActiveRole(), getActiveTenant(), subscribeAuthState(), membershipKey(), SchoolOption (+11 more)
...
Cohesion: 0.08
Nodes (46): ClassesTabProps, FeeStructuresTab(), FeeStructuresTabProps, TabQueryState(), TabQueryStateProps, TAB_IDS, FeeStructuresTab(), FeeStructuresTabProps (+38 more)
...
Cohesion: 0.08
Nodes (37): Default, Empty, meta, RightToLeft, Story, formatValidPhone(), PhoneInput(), PhoneInputProps (+29 more)
...
Cohesion: 0.09
Nodes (25): primaryGuardianName(), SORT_FIELD_BY_COLUMN, StudentFilters, StudentsListPage(), studentsSearchSchema, toStudentListFilters(), Default, LocaleSample() (+17 more)
...
Cohesion: 0.08
Nodes (22): Global, AuditModule, Module, AuditService, RecordAuditEntryInput, Injectable, InjectRepository, AuditLog (+14 more)
...
Cohesion: 0.09
Nodes (21): createI18nInstance(), i18n, whenReady(), DocumentLocaleSync(), I18nProvider(), I18nProviderProps, clearPersistedLocale(), getPersistedLocale() (+13 more)
...
Cohesion: 0.12
Nodes (27): AcademicYearDetailPage(), TAB_IDS, DeleteYearDialog(), ClassesTab(), SetCurrentDialog(), YearFormDialog(), YearFormPayload, ClassDetailPage() (+19 more)
...
Cohesion: 0.12
Nodes (21): CommunicationsModule, Module, ProviderNotConfiguredError, EmailOverride, MessengerOverride, ResolvedMessengerConfig, ResolvedSmsConfig, SmsOverride (+13 more)
...
Cohesion: 0.13
Nodes (21): ConnectionTestResultMessage(), ConnectionTestResultMessageProps, MutationErrorMessage(), SecretField(), SecretFieldProps, EmailConfig, EmailFormValues, emailSchema (+13 more)
...
Cohesion: 0.06
Nodes (49): Combobox(), ComboboxOption, ComboboxProps, CLASS_OPTIONS, Default, Empty, meta, NoResults (+41 more)

### Community 71 - "SendBulkReminderDto"
Cohesion: 0.05
Nodes (62): ArrayMaxSize, ReminderBatchResponseDto, SendBulkReminderDto, SkippedRecipientDto, ArrayNotEmpty, IsArray, IsEnum, IsNotEmpty (+54 more)

### Community 72 - "devDependencies"
Cohesion: 0.07
Nodes (27): axe-core, eslint-config-prettier, @eslint/js, eslint-plugin-jsx-a11y, eslint-plugin-react-hooks, eslint-plugin-unused-imports, globals, lint-staged (+19 more)

### Community 73 - "school-settings.ts"
Cohesion: 0.06
Nodes (31): Default, Grouped, meta, MobileDrawer, navGroups, navItems, RightToLeft, Story (+23 more)
...
Cohesion: 0.15
Nodes (17): StatisticsTab(), StatisticsTabProps, InvoiceFilters, InvoicesListPage(), invoicesSearchSchema, toInvoiceListFilters(), InvoiceDetailPage(), OutstandingFeesStep() (+9 more)
...
Cohesion: 0.11
Nodes (22): CommunicationStatus, EnrollmentStatus, ReminderBatchStatus, ACADEMIC_YEAR_STATUS_TONE, AcademicYearCurrentStatus, COMMUNICATION_STATUS_TONE, ENROLLMENT_STATUS_TONE, FEE_STATUS_TONE (+14 more)
...
Cohesion: 0.17
Nodes (10): EMPTY_PAGE, PaymentForm(), apiErrorBody, renderHookWithProviders(), RenderHookWithProvidersOptions, RenderHookWithProvidersResult, createTestQueryClient(), RenderWithProvidersOptions (+2 more)
...
Cohesion: 0.05
Nodes (37): InjectQueue, InjectRepository, CommunicationLog, Column, CreateDateColumn, Entity, Index, JoinColumn (+29 more)
...
Cohesion: 0.15
Nodes (6): ResolvedWhatsAppConfig, CommunicationSendParams, ConnectionTestResult, isValidGraphApiId(), isValidGraphApiVersion(), mapMetaGraphError()
...
Cohesion: 0.07
Nodes (39): ClassesListPage(), ClassFilters, deriveRowStatus(), DuesFilters, DuesQueuePage(), duesSearchSchema, SORT_FIELD_BY_COLUMN, toFeeDuesFilters() (+31 more)
...
Cohesion: 0.10
Nodes (22): buildReceiptHtml(), escapeHtml(), printReceipt(), Receipt(), ReceiptProps, LABELS, PaymentsTab(), MoneyInput() (+14 more)

### Community 162 - "route-announcer.tsx"
Cohesion: 0.14
Nodes (12): ButtonBaseProps, ButtonProps, PaginationProps, Default, Empty, FirstPage, LastPage, meta (+4 more)
...
## Knowledge Gaps
- **1217 isolated node(s):** `semi`, `singleQuote`, `trailingComma`, `printWidth`, `prettier-plugin-tailwindcss` (+1212 more)
...
- **Why does `useListUrlState()` connect `router-integration.test.tsx` to `dues.tsx`, `getActiveTenant`, `menu.tsx`, `wizard-shell.stories.tsx`?**
  _High betweenness centrality (0.170) - this node is a cross-community bridge._
- **Why does `AccessTokenDenylistService` connect `getActiveTenant` to `auth.service.ts`?**
  _High betweenness centrality (0.082) - this node is a cross-community bridge._
- **Why does `useListShellState()` connect `dues.tsx` to `session.ts`, `menu.tsx`, `router-integration.test.tsx`, `RegionConfig`, `index.tsx`, `index.ts`, `date-picker.tsx`, `detail-shell.stories.tsx`?**
