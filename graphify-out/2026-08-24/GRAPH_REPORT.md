...
## Corpus Check
- 839 files · ~407,797 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4860 nodes · 12443 edges · 283 communities (207 shown, 76 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 221 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cc1c216d`
...
## Communities (283 total, 76 thin omitted)

### Community 0 - "app.module.ts"
Cohesion: 0.06
Nodes (46): TeacherClassSection, Column, CreateDateColumn, Entity, JoinColumn, ManyToOne, PrimaryGeneratedColumn, Unique (+38 more)
...
### Community 3 - "Student"
Cohesion: 0.05
Nodes (64): ClassFormDialog(), ClassFormDialogProps, ClassFormInitialValues, EMPTY_VALUES, ClassesListPage(), ClassFilters, SectionFormDialog(), deriveRowStatus() (+56 more)
...
Cohesion: 0.05
Nodes (89): FeeStatus, apiClient, academicYearQueryOptions(), academicYearStatsQueryOptions(), AuditLog, auditLogKeys, PaginatedAuditLogs, useAuditLogsByEntity() (+81 more)

### Community 9 - "School"
Cohesion: 0.05
Nodes (83): AcademicYearModule, Module, AcademicYearStats, InjectRepository, AcademicYear, Column, CreateDateColumn, DeleteDateColumn (+75 more)

### Community 10 - "rtl-decorator.tsx"
Cohesion: 0.07
Nodes (44): ApiHideProperty, Column, CreateDateColumn, Entity, Index, JoinColumn, ManyToOne, PrimaryGeneratedColumn (+36 more)

### Community 11 - "menu.tsx"
Cohesion: 0.08
Nodes (25): DataTable(), DataTableProps, DataTableSort, readPersistedState(), COLUMNS, Student, STUDENTS, MenuCheckboxItem() (+17 more)

### Community 12 - "Roles"
Cohesion: 0.04
Nodes (64): ApiBody, ApiConsumes, ApiOperation, Delete, Get, Param, Patch, CurrentTenant (+56 more)

### Community 13 - "client.ts"
Cohesion: 0.14
Nodes (26): clearAuthState(), currentSessionGeneration(), listeners, notifyAuthStateChange(), notifySessionExpired(), registerSessionExpiredHandler(), setAccessToken(), setActiveRole() (+18 more)

### Community 14 - "support.ts"
Cohesion: 0.04
Nodes (57): AuditEntry, Guardian, Invoice, Teacher, worker, wsPassthrough, auditLogDefaultHandlers, auditLogHandlers (+49 more)

### Community 15 - "index.ts"
Cohesion: 0.18
Nodes (23): EmailConfig, EmailFormValues, emailSchema, EmailSection(), EmailSectionProps, MessengerSection(), RegionalSection(), SmsSection() (+15 more)

### Community 16 - "list-shell.stories.tsx"
Cohesion: 0.10
Nodes (17): GenerateFeesResultDto, FeeController, ApiOperation, ApiTags, Body, Controller, Delete, Get (+9 more)
...
Cohesion: 0.21
Nodes (12): CurrencyGrouping, NumeralSystem, minorUnitsToDecimalString(), roundDecimalString(), serverAmountToMinorUnits(), renderDigits(), toLatinDigits(), groupDigits() (+4 more)

### Community 19 - "dialog.tsx"
Cohesion: 0.06
Nodes (52): DeleteYearDialog(), DeleteYearDialogProps, SetCurrentDialog(), SetCurrentDialogProps, EMPTY_VALUES, YearFormDialog(), YearFormDialogProps, YearFormInitialValues (+44 more)
...
Cohesion: 0.05
Nodes (57): Check, PaymentAllocation, Column, CreateDateColumn, Entity, Index, JoinColumn, ManyToOne (+49 more)

### Community 22 - "index.ts"
Cohesion: 0.14
Nodes (14): adminOwnSchool, CONFIGURED_EMAIL, twoSchools, routeTree, classFactory(), classSectionFactory(), authHandlers, enrollmentFactory() (+6 more)

### Community 23 - "app-shell.tsx"
Cohesion: 0.08
Nodes (28): GlobalSearchLauncher(), Permission, ROLE_PERMISSIONS, AppShell(), AppShellNavGroup, AppShellNavItem, AppShellProps, NavContent() (+20 more)
...
### Community 25 - "cn"
Cohesion: 0.12
Nodes (17): CheckboxProps, LabelProps, TextareaProps, Checkbox(), Label(), cn(), RadioGroup(), RadioGroupItem() (+9 more)
...
Cohesion: 0.15
Nodes (15): SchoolSettingsPage(), SelectSchoolPage(), selectSchoolSearchSchema, getAccessToken(), getActiveRole(), getActiveTenant(), subscribeAuthState(), dualRoleOneSchool (+7 more)
...
Cohesion: 0.08
Nodes (23): AcademicYearController, ApiTags, Body, Controller, Inject, Post, Query, UseGuards (+15 more)
...
Cohesion: 0.06
Nodes (75): ClassesTabProps, FeeStructuresTab(), FeeStructuresTabProps, StatisticsTab(), StatisticsTabProps, TabQueryState(), TabQueryStateProps, FeeStructuresTab() (+67 more)
...
Cohesion: 0.15
Nodes (20): NewStudentPage(), fieldId(), buildCreatePayload(), buildStudentFormSchema(), buildUpdatePayload(), defaultStudentFormValues(), PREFERRED_COMMUNICATION_VALUES, messages (+12 more)
...
Cohesion: 0.21
Nodes (15): AcademicYearsListPage(), ClassesCountCell(), StudentsCountCell(), AcademicYear, academicYearKeys, AcademicYearListFilters, academicYearsQueryOptions(), AcademicYearStats (+7 more)
...
Cohesion: 0.12
Nodes (18): CalendarProps, MoneyInputProps, PhoneInputProps, LOCALE_REGION_DEFAULTS, RegionConfigContext, RegionConfigProviderProps, CurrencySymbol(), Numerals() (+10 more)

### Community 47 - "router-integration.test.tsx"
Cohesion: 0.12
Nodes (19): useSearchNavigate(), RequireRoleProps, forbiddenRoute, reportsRoute, rootRoute, routeTree, StudentsListRoute(), studentsRoute (+11 more)
...
Cohesion: 0.11
Nodes (17): StudentsTab(), FindStudentStep(), FindStudentStepProps, emptyDraft(), GuardianPicker(), GuardianPickerProps, NewGuardianDraft, Placeholder() (+9 more)
...
Cohesion: 0.06
Nodes (26): Global, Optional, AuditService, RecordAuditEntryInput, Injectable, InjectRepository, AuditLog, Column (+18 more)
...
Cohesion: 0.10
Nodes (28): AcademicYearDetailPage(), TAB_IDS, ClassesTab(), ClassDetailPage(), TAB_IDS, SectionsTab(), SectionsTabProps, SectionsPanel() (+20 more)
...
Cohesion: 0.18
Nodes (14): AuditAction, CommunicationTrigger, FeeApplicability, FeeType, PaymentAllocationType, PaymentMethod, UserStatus, FeeLineItem (+6 more)

### Community 70 - "notification-state.ts"
Cohesion: 0.13
Nodes (21): ComboboxProps, Calendar(), DatePickerProps, daysInMonth(), sameDay(), PopoverAnchor(), PopoverAnchorProps, PopoverContentProps (+13 more)
...
Cohesion: 0.07
Nodes (27): axe-core, eslint-config-prettier, @eslint/js, eslint-plugin-import, eslint-plugin-jsx-a11y, eslint-plugin-react-hooks, eslint-plugin-unused-imports, lint-staged (+19 more)
...
Cohesion: 0.08
Nodes (26): scripts, api:types, build:all, build:client-admin, build:server, build:shared, build:ui, coverage (+18 more)
...
Cohesion: 0.07
Nodes (34): FormControl(), FormDescription(), FormField(), FormFieldContext, FormFieldContextValue, FormItem(), FormItemContext, FormItemContextValue (+26 more)
...
Cohesion: 0.10
Nodes (21): CommunicationStatus, PaymentStatus, ReminderBatchStatus, ACADEMIC_YEAR_STATUS_TONE, AcademicYearCurrentStatus, COMMUNICATION_STATUS_TONE, ENROLLMENT_STATUS_TONE, FEE_STATUS_TONE (+13 more)
...
Cohesion: 0.04
Nodes (46): CustomRetryLabel, Default, meta, RightToLeft, Story, Default, meta, NoResults (+38 more)

### Community 117 - "auth-state.ts"
Cohesion: 0.18
Nodes (9): EMPTY_PAGE, PaymentForm(), useCreatePayment(), apiErrorBody, renderHookWithProviders(), RenderHookWithProvidersOptions, RenderHookWithProvidersResult, createTestQueryClient() (+1 more)
...
### Community 160 - "money-input.stories.tsx"
Cohesion: 0.36
...
## Knowledge Gaps
- **1222 isolated node(s):** `semi`, `singleQuote`, `trailingComma`, `printWidth`, `prettier-plugin-tailwindcss` (+1217 more)
...
- **Why does `useListUrlState()` connect `router-integration.test.tsx` to `Student`, `menu.tsx`, `auth.service.ts`?**
  _High betweenness centrality (0.161) - this node is a cross-community bridge._
- **Why does `useUpdateSchoolSettings()` connect `index.ts` to `formatServerAmount`, `receipt.tsx`, `classes.ts`, `AuditLog`, `number.ts`?**
