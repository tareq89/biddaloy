...
## Corpus Check
- 929 files · ~453,432 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5222 nodes · 13684 edges · 303 communities (227 shown, 76 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 246 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a1c9b3d7`
...
## Communities (303 total, 76 thin omitted)
...
Cohesion: 0.15
Nodes (22): Route, SelectSchoolPage(), selectSchoolSearchSchema, JwtMembership, getAccessToken(), bootstrap(), clearScheduledRefresh(), decodeAccessTokenMemberships() (+14 more)
...
Cohesion: 0.10
Nodes (29): @nestjs/swagger, ApiTenantAuth(), TestController, requestContext, AuditLogListResponseDto, AuditLogResponseDto, ApiProperty, CurrentUser (+21 more)

### Community 6 - "StudentService"
Cohesion: 0.07
Nodes (40): LOCALE_LABELS, LocaleSwitcherProps, Menu(), MenuCheckboxItem(), MenuCheckboxItemProps, MenuContent(), MenuContentProps, MenuGroup() (+32 more)
...
### Community 9 - "School"
Cohesion: 0.04
Nodes (64): InjectRepository, AcademicYear, Column, CreateDateColumn, DeleteDateColumn, Entity, Index, JoinColumn (+56 more)
...
### Community 12 - "Roles"
Cohesion: 0.06
Nodes (46): ApiBody, ApiConsumes, AcademicYearController, ApiOperation, ApiTags, Body, Controller, Delete (+38 more)
...
Cohesion: 0.03
Nodes (81): Teacher, worker, wsPassthrough, academicYearDefaultHandlers, academicYearHandlers, create, fixtures, getOne (+73 more)

### Community 15 - "index.ts"
Cohesion: 0.11
Nodes (27): ClassController, ApiOperation, ApiTags, Body, Controller, Get, Inject, Param (+19 more)
...
Cohesion: 0.22
Nodes (5): AcademicYearStats, makeFee(), monthOffset(), ALL_ENTITIES, createTestModule()
...
Cohesion: 0.04
Nodes (87): GlobalSearchLauncher(), DeleteYearDialogProps, SetCurrentDialogProps, EMPTY_VALUES, YearFormDialogProps, YearFormInitialValues, DeleteClassDialogProps, DeleteSectionDialogProps (+79 more)
...
Cohesion: 0.05
Nodes (50): Check, PaymentAllocation, Column, CreateDateColumn, Entity, Index, JoinColumn, ManyToOne (+42 more)

### Community 22 - "index.ts"
Cohesion: 0.09
Nodes (21): adminOwnSchool, CONFIGURED_EMAIL, twoSchools, KLASS, PRIOR_KLASS, PRIOR_YEAR, render(), SECTION (+13 more)

### Community 23 - "app-shell.tsx"
Cohesion: 0.15
Nodes (13): RouterContext, GUARDIAN_ROLES, isGuardianRole(), isStaffRole(), STAFF_ROLES, AuditAction, CommunicationTrigger, UserRole (+5 more)
...
Cohesion: 0.16
Nodes (15): DeleteClassDialog(), DeleteSectionDialog(), SectionsTab(), SectionsTabProps, SectionFormDialog(), SectionsPanel(), SectionsPanelProps, classKeys (+7 more)

### Community 27 - "fees.ts"
Cohesion: 0.11
Nodes (10): getActiveRole(), getActiveTenant(), dualRoleOneSchool, singleSchool, twoSchools, RequireRole(), RequireRoleProps, mockOnlineStatus() (+2 more)
...
Cohesion: 0.08
Nodes (56): ClassesTabProps, FeeStructuresTab(), FeeStructuresTabProps, StatisticsTab(), StatisticsTabProps, TabQueryState(), TabQueryStateProps, FeeStructuresTab() (+48 more)
...
Cohesion: 0.20
Nodes (15): NewStudentPage(), fieldId(), buildCreatePayload(), buildStudentFormSchema(), buildUpdatePayload(), defaultStudentFormValues(), PREFERRED_COMMUNICATION_VALUES, messages (+7 more)

### Community 41 - "record-payment-wizard.tsx"
Cohesion: 0.09
Nodes (33): AllocateStepProps, AllocationLine, AllocationSummary, AllocationType, applyLineEdit(), classifyAllocationType(), OutstandingFee, prefillFifoAllocations() (+25 more)

### Community 42 - "index.ts"
Cohesion: 0.29
Nodes (16): EmailSection(), MessengerConfig, MessengerFormValues, messengerSchema, MessengerSection(), MessengerSectionProps, RegionalSection(), SmsSection() (+8 more)
...
Cohesion: 0.15
Nodes (10): Combobox(), ComboboxOption, CLASS_OPTIONS, Default, Empty, meta, NoResults, RightToLeft (+2 more)

### Community 48 - "auth.test.ts"
Cohesion: 0.08
Nodes (31): LabelProps, TableBodyProps, TableCaptionProps, TableCellProps, TableFooter(), TableFooterProps, TableHeaderProps, TableHeadProps (+23 more)
...
Cohesion: 0.21
Nodes (10): RegionSettings, CalendarProps, DatePickerProps, PhoneInputProps, LOCALE_REGION_DEFAULTS, RegionConfigContext, RegionConfigProviderProps, RegionConfig (+2 more)
...
Cohesion: 0.15
Nodes (10): InputProps, Default, Disabled, Empty, InvalidValue, Loading, meta, RightToLeft (+2 more)
...
Cohesion: 0.03
Nodes (136): SchoolSettingsPage(), StructureFormDialog(), StructureFormDialogProps, TransferDialog(), TeacherDesignation, apiClient, AcademicYear, academicYearKeys (+128 more)
...
Cohesion: 0.27
Nodes (11): FeeStatus, PaymentAllocationType, PaymentMethod, PaymentStatus, FeeLineItem, InvoiceResponse, PaymentAllocationResponse, PaymentDueSummary (+3 more)
...
Cohesion: 0.10
Nodes (19): Default, Grouped, meta, MobileDrawer, navGroups, navItems, RightToLeft, Story (+11 more)
...
Cohesion: 0.11
Nodes (25): ComboboxProps, Calendar(), daysInMonth(), sameDay(), Popover(), PopoverAnchor(), PopoverAnchorProps, PopoverContent() (+17 more)
...
Cohesion: 0.17
Nodes (5): Route, Route, Route, EmptyState(), EmptyStateProps
...
Cohesion: 0.13
Nodes (17): Route, subscribeAuthState(), AppShell(), membershipKey(), SchoolOption, Default, meta, RightToLeft (+9 more)
...
Cohesion: 0.07
Nodes (31): useSearchNavigate(), forbiddenRoute, reportsRoute, rootRoute, routeTree, StudentsListRoute(), studentsRoute, ListUrlState (+23 more)
...
Cohesion: 0.13
Nodes (12): ApiErrorBody, NoActiveTenantError, RateLimitedError, createAppQueryClient(), handleGlobalQueryError(), Default, ErrorVariant, meta (+4 more)

### Community 117 - "auth-state.ts"
Cohesion: 0.07
Nodes (34): EMPTY_PAGE, PaymentForm(), Student, authDefaultHandlers, login, loginInvalidCredentials, loginRateLimited, loginResponseFactory() (+26 more)
...
Cohesion: 0.06
Nodes (35): JoinTable, InjectQueue, InjectRepository, InjectQueue, InjectRepository, Guardian, Column, CreateDateColumn (+27 more)
...
Cohesion: 0.06
Nodes (68): AcademicYearDetailPage(), TAB_IDS, DeleteYearDialog(), AcademicYearsListPage(), ClassesCountCell(), StudentsCountCell(), SetCurrentDialog(), YearFormDialog() (+60 more)
...
Cohesion: 0.20
Nodes (9): CommunicationStatus, ReminderBatchStatus, AllDomains, Default, FeeStructureRecurrence, Greyscale, meta, RightToLeft (+1 more)
...
Cohesion: 0.16
Nodes (13): formatGuardianPhone(), formatValidPhone(), PhoneInput(), Default, Disabled, Empty, Invalid, meta (+5 more)
...
Cohesion: 0.05
Nodes (65): ClassesTab(), ClassFormDialog(), ClassFormDialogProps, ClassFormInitialValues, EMPTY_VALUES, ClassesListPage(), ClassFilters, DeleteStructureDialog() (+57 more)

### Community 216 - "date-picker.stories.tsx"
Cohesion: 0.23
Nodes (9): NumeralSystem, REGION_BD_BN, REGION_FIXTURE, getAcademicYear(), julyStart, julyStartBn, toLatinDigits(), parseNumber() (+1 more)
...
Cohesion: 0.53
Nodes (4): CurrencyGrouping, groupDigits(), groupLakhCrore(), groupThousand()
...
### Community 224 - "index.tsx"
Cohesion: 0.50
Nodes (3): detectLoginIdentifier(), emailSchema, LoginIdentifier

### Community 229 - "matchers.ts"
Cohesion: 0.50
...
Cohesion: 0.19
Nodes (8): buildLoginError(), LoginPage(), loginSearchSchema, SignInCredentials, SignInForm(), SignInFormError, SignInFormProps, SignInFormValues
...
Cohesion: 0.04
Nodes (50): Default, Disabled, Error, IconOnly, Loading, meta, RightToLeft, Story (+42 more)
...
## Knowledge Gaps
- **1300 isolated node(s):** `semi`, `singleQuote`, `trailingComma`, `printWidth`, `prettier-plugin-tailwindcss` (+1295 more)
...
- **Why does `useListUrlState()` connect `wizard-shell.stories.tsx` to `academic-years.ts`, `jsdom`, `phone-input.stories.tsx`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `requestContext` connect `invoices.controller.ts` to `users.controller.ts`, `User`, `HealthModule`, `.updateSettings`, `SendBulkReminderDto`, `Roles`, `pagination.stories.tsx`, `all-entities.ts`, `eslint-config.mjs`, `.testConnection`, `index.ts`, `fees.controller.ts`, `button.stories.tsx`, `.login`?**
