...
4. `School` - 69 edges
5. `ClassSection` - 64 edges
6. `User` - 63 edges
7. `cn()` - 59 edges
8. `Class` - 58 edges
9. `AcademicYear` - 57 edges
...
### Community 0 - "School"
Cohesion: 0.06
Nodes (60): AcademicYear, Column, CreateDateColumn, DeleteDateColumn, Entity, Index, JoinColumn, ManyToOne (+52 more)

### Community 1 - "index.ts"
Cohesion: 0.06
Nodes (64): GlobalSearchLauncher(), SecretFieldProps, EmailSectionProps, MessengerSectionProps, RegionalSectionProps, SmsSectionProps, WhatsAppSectionProps, Default (+56 more)

### Community 2 - "Roles"
Cohesion: 0.06
Nodes (46): ApiBody, ApiConsumes, CurrentTenant, CurrentUser, TestController, Roles(), Delete, CommunicationsController (+38 more)
...
Cohesion: 0.06
Nodes (59): InputProps, LOCALE_LABELS, LocaleSwitcherProps, Menu(), MenuCheckboxItem(), MenuCheckboxItemProps, MenuContent(), MenuContentProps (+51 more)

### Community 6 - "rtl-decorator.tsx"
Cohesion: 0.04
Nodes (51): Default, Grouped, meta, MobileDrawer, navGroups, navItems, RightToLeft, Story (+43 more)

### Community 7 - "handlers.ts"
Cohesion: 0.04
Nodes (48): AuditEntry, auditEntryFactory(), FeeStructure, Guardian, StudentFee, UserResponseDto, worker, wsPassthrough (+40 more)

### Community 8 - "invoices.controller.ts"
Cohesion: 0.10
Nodes (27): @nestjs/swagger, ApiTenantAuth(), TestController, AuditLogListResponseDto, AuditLogResponseDto, ApiProperty, ContextGuard, resolveRole() (+19 more)

### Community 9 - "index.ts"
Cohesion: 0.07
Nodes (32): queryClient, Register, router, @tanstack/react-router, currentSessionGeneration(), registerSessionExpiredHandler(), apiClient, postAuthLogin() (+24 more)
...
Cohesion: 0.10
Nodes (31): createI18nInstance(), i18n, whenReady(), DocumentLocaleSync(), I18nProvider(), I18nProviderProps, clearPersistedLocale(), getPersistedLocale() (+23 more)

### Community 13 - "classes.controller.ts"
Cohesion: 0.10
Nodes (28): ClassController, ApiOperation, ApiTags, Body, Controller, Get, Inject, Param (+20 more)

### Community 14 - "auth.test.ts"
Cohesion: 0.10
Nodes (32): Route, SelectSchoolPage(), selectSchoolSearchSchema, UserRole, JwtMembership, JwtPayload, LoginResponse, postAuthLogout() (+24 more)

### Community 15 - "button.tsx"
Cohesion: 0.07
Nodes (37): ButtonBaseProps, ButtonProps, Dialog(), DialogClose(), DialogCloseProps, DialogContent(), DialogContentProps, DialogDescription() (+29 more)
...
Cohesion: 0.08
Nodes (39): AuditAction, CommunicationStatus, CommunicationTrigger, EnrollmentStatus, FeeApplicability, FeeStatus, FeeType, InvoiceStatus (+31 more)

### Community 18 - "index.ts"
Cohesion: 0.17
Nodes (35): CommunicationMedium, BD_MOBILE_PREFIXES, BN_DISTRICTS, BN_FEMALE_FIRST_NAMES, BN_LAST_NAMES, BN_MALE_FIRST_NAMES, bnAddress(), bnFullName() (+27 more)

### Community 19 - "AuditService"
Cohesion: 0.08
Nodes (16): Optional, AuditService, RecordAuditEntryInput, Injectable, AccessTokenDenylistService, Inject, Injectable, Inject (+8 more)
...
Cohesion: 0.06
Nodes (29): Global, buildRateLimitTracker(), AcademicYearModule, Module, AuditModule, Module, InjectRepository, AuditLog (+21 more)

### Community 26 - "cn"
Cohesion: 0.10
Nodes (26): Label(), LabelProps, Skeleton(), Default, meta, RowOfFields, Story, Checkbox() (+18 more)
...
Cohesion: 0.10
Nodes (24): Permission, ROLE_PERMISSIONS, AppShell(), AppShellNavGroup, AppShellNavItem, AppShellProps, NavContent(), NavGroupSection() (+16 more)

### Community 31 - "EmailSection.tsx"
Cohesion: 0.16
Nodes (28): ConnectionTestResultMessage(), ConnectionTestResultMessageProps, MutationErrorMessage(), SecretField(), EmailConfig, EmailFormValues, emailSchema, EmailSection() (+20 more)
...
Cohesion: 0.07
Nodes (28): JoinTable, InjectRepository, InjectRepository, Guardian, Column, CreateDateColumn, DeleteDateColumn, Entity (+20 more)
...
Cohesion: 0.13
Nodes (23): requestContext, SkippedGuardianDto, addressForMedium(), DISPATCHABLE_MEDIA, selectReminderGuardians(), findUnsupportedPlaceholders(), formatDueAmount(), formatDueMonth() (+15 more)
...
Cohesion: 0.12
Nodes (12): adminOwnSchool, CONFIGURED_EMAIL, routeTree, dualRoleOneSchool, singleSchool, twoSchools, RenderHookWithProvidersOptions, cleanupTestState() (+4 more)

### Community 41 - "router-integration.test.tsx"
Cohesion: 0.11
Nodes (22): useSearchNavigate(), RequireRole(), RequireRoleProps, forbiddenRoute, reportsRoute, rootRoute, routeTree, StudentsListRoute() (+14 more)

### Community 42 - "getActiveTenant"
Cohesion: 0.11
Nodes (13): SchoolSettingsPage(), getAccessToken(), getActiveRole(), getActiveTenant(), subscribeAuthState(), useAccessToken(), useActiveRole(), useActiveTenant() (+5 more)
...
Cohesion: 0.09
Nodes (19): AuthResult, RefreshToken, Column, CreateDateColumn, Entity, Index, JoinColumn, ManyToOne (+11 more)

### Community 48 - "region-config.ts"
Cohesion: 0.13
Nodes (15): formatValidPhone(), PhoneInput(), PhoneInputProps, Default, Disabled, Empty, Invalid, meta (+7 more)
...
Cohesion: 0.11
Nodes (20): twoSchools, PaymentForm(), useCreatePayment(), authDefaultHandlers, authHandlers, login, loginInvalidCredentials, loginRateLimited (+12 more)
...
Cohesion: 0.19
Nodes (17): Calendar(), DatePicker(), daysInMonth(), sameDay(), formatAcademicYear(), formatDate(), getAcademicYear(), parseDate() (+9 more)
...
Cohesion: 0.10
Nodes (18): SchoolsController, patch(), REQUEST, USER, ApiForbiddenResponse, ApiOkResponse, ApiOperation, ApiTags (+10 more)

### Community 60 - "detail-shell.stories.tsx"
Cohesion: 0.10
Nodes (19): DetailShell(), DetailShellTab, CachedTabState, DeepLinkedTab, Default, meta, PermissionGated, RightToLeft (+11 more)
...
Cohesion: 0.14
Nodes (13): Button(), DetailShellAction, collectErrorPaths(), RHF_ERROR_METADATA_KEYS, FormSection(), FormSectionProps, FormShell(), FormShellError (+5 more)
...
Cohesion: 0.09
Nodes (22): FileRoutesByFullPath, FileRoutesByTo, FileRouteTypes, IndexRoute, LoginRoute, PortalFeesRoute, PortalIndexRoute, PortalRoute (+14 more)
...
Cohesion: 0.09
Nodes (20): Invoice, Payment, create, fixtures, getOne, invoiceDefaultHandlers, invoiceHandlers, list (+12 more)
...
Cohesion: 0.22
Nodes (14): academicYearFactory(), classFactory(), classSectionFactory(), SECTION_NAMES, feeStructureFactory(), schoolFactory(), create, Enrollment (+6 more)
...
Cohesion: 0.14
Nodes (16): ReminderPreviewRecipientDto, ReminderPreviewResponseDto, SendSingleReminderDto, SentReminderRecipientDto, SingleReminderResponseDto, IsArray, IsEnum, IsNotEmpty (+8 more)
...
Cohesion: 0.26
Nodes (14): clearAuthState(), listeners, notifyAuthStateChange(), notifySessionExpired(), setAccessToken(), setActiveRole(), setActiveTenant(), seedSession() (+6 more)
...
Cohesion: 0.17
Nodes (13): CalendarProps, DatePickerProps, MoneyInput(), MoneyInputProps, CurrencyGrouping, REGION_BD_BN, RegionConfig, REGION_FIXTURE (+5 more)
...
Cohesion: 0.24
Nodes (8): buildVersioningOptions(), buildDocsBasicAuthMiddleware(), buildDocsCspOverrideMiddleware(), safeCompare(), generateOpenApiDocument(), buildSwaggerDocumentConfig(), createApp(), shouldMountDocs()

### Community 91 - "StudentService"
Cohesion: 0.16
Nodes (8): InjectQueue, InjectRepository, InjectQueue, InjectRepository, Inject, GuardianService, StudentService, Injectable
...
Cohesion: 0.18
Nodes (12): captureRouteError(), ErrorState(), ErrorStateProps, CustomRetryLabel, Default, meta, RightToLeft, Story (+4 more)

### Community 100 - "use-route-focus.test.tsx"
Cohesion: 0.13
Nodes (10): focusAnchorMemory, blankRoute, detailRoute, listRoute, otherListRoute, RootLayout(), rootRoute, routeTree (+2 more)
...
Cohesion: 0.20
Nodes (10): eslint, eslint, biddaloyReactConfig, componentBoundaryConfig, dataFetchingGuardConfig, financialMutationGuardConfig, noWindowAlertConfig, typeCheckedTestOverrides (+2 more)
...
Cohesion: 0.16
Nodes (11): membershipKey(), SchoolOption, Default, meta, RightToLeft, SingleMembership, singleSchool, Story (+3 more)
...
### Community 126 - "pagination.stories.tsx"
Cohesion: 0.20
...
Cohesion: 0.36
Nodes (3): bootstrap(), buildSpaFallback(), SendFileCall
...
### Community 155 - "route-guard-coverage.e2e-spec.ts"
Cohesion: 0.25
...
### Community 172 - "Biddaloy CLAUDE.md"
Cohesion: 0.40
...
### Community 174 - "client-admin/src/main.tsx entry point"
Cohesion: 0.40
