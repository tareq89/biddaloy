...
## Corpus Check
- 1002 files · ~535,336 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5674 nodes · 15449 edges · 307 communities (230 shown, 77 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 293 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `254e12e5`
...
## Communities (307 total, 77 thin omitted)

### Community 0 - "app.module.ts"
Cohesion: 0.03
Nodes (61): worker, wsPassthrough, authDefaultHandlers, login, loginInvalidCredentials, loginRateLimited, loginResponseFactory(), logout (+53 more)

### Community 1 - "User"
Cohesion: 0.09
Nodes (16): SchoolSettingsPage(), RouterContext, GUARDIAN_ROLES, isGuardianRole(), isStaffRole(), getAccessToken(), getActiveRole(), getActiveTenant() (+8 more)

### Community 2 - "ClassController"
Cohesion: 0.06
Nodes (31): JoinTable, createStudentEnrolledIn(), InjectRepository, EnrollmentService, Injectable, InjectRepository, Enrollment, Column (+23 more)

### Community 3 - "Student"
Cohesion: 0.09
Nodes (26): DeleteStudentDialog(), TransferStatusDialog(), TransferStatusDialogProps, apiClient, BulkUploadError, BulkUploadResult, BulkUploadStudentsInput, useBulkUploadStudents() (+18 more)
...
Cohesion: 0.05
Nodes (87): AcademicYearModule, Module, AcademicYearStats, AcademicYear, Column, CreateDateColumn, DeleteDateColumn, Entity (+79 more)

### Community 9 - "School"
Cohesion: 0.10
Nodes (22): CheckboxProps, LabelProps, TextareaProps, Checkbox(), DropdownMenu(), DropdownMenuCheckboxItem(), DropdownMenuContent(), DropdownMenuGroup() (+14 more)

### Community 10 - "rtl-decorator.tsx"
Cohesion: 0.13
Nodes (25): DiffPanel(), DiffPanelProps, renderPanel(), changedFieldCount(), compactJson(), deepEqual(), DiffField, diffFields() (+17 more)

### Community 11 - "menu.tsx"
Cohesion: 0.08
Nodes (36): ClassFormDialog(), DeleteSectionDialog(), SectionFormDialog(), PromoteTeacherDialog(), TeacherDesignation, Class, classesQueryOptions(), classKeys (+28 more)

### Community 12 - "Roles"
Cohesion: 0.06
Nodes (47): ApiBody, ApiConsumes, AcademicYearController, ApiOperation, ApiTags, Body, Controller, Delete (+39 more)
...
Cohesion: 0.03
Nodes (58): PaginatedAuditEntries, renderAuditLogs(), AuditEntry, Class, auditLogDefaultHandlers, auditLogHandlers, fixtures, list (+50 more)

### Community 15 - "index.ts"
Cohesion: 0.12
Nodes (18): CurrentUser, FeeController, ApiExtraModels, ApiOkResponse, ApiOperation, ApiTags, Body, Controller (+10 more)
...
Cohesion: 0.04
Nodes (108): DeleteYearDialogProps, SetCurrentDialogProps, EMPTY_VALUES, YearFormDialogProps, YearFormInitialValues, ClassFormDialogProps, ClassFormInitialValues, EMPTY_VALUES (+100 more)

### Community 20 - "students.controller.ts"
Cohesion: 0.07
Nodes (43): SanitizeAllowlist(), SanitizeText(), shared, AllowlistDto, { sanitizeAllowlist, sanitizeStrict }, StrictDto, CreateAcademicYearDto, IsBeforeConstraint (+35 more)
...
Cohesion: 0.05
Nodes (48): adminOwnSchool, CONFIGURED_EMAIL, child(), FeeInput, invoice(), mockFees(), renderFees(), serverDate() (+40 more)
...
Cohesion: 0.06
Nodes (57): AcademicYearDetailPage(), TAB_IDS, DeleteYearDialog(), ClassesTab(), StatisticsTab(), StatisticsTabProps, TabQueryState(), TabQueryStateProps (+49 more)
...
Cohesion: 0.04
Nodes (79): GlobalSearchLauncher(), AppShellNavGroup, ButtonBaseProps, ButtonProps, DataTable(), DataTableProps, readPersistedState(), EmptyState() (+71 more)

### Community 29 - "AcademicYearController"
Cohesion: 0.22
Nodes (7): Query, QueryAcademicYearDto, IsInt, IsOptional, Max, Min, Type
...
Cohesion: 0.07
Nodes (56): payment(), ClassesTabProps, FeeStructuresTab(), FeeStructuresTabProps, FeeStructuresTab(), FeeStructuresTabProps, StudentsTabProps, TabQueryState() (+48 more)
...
Cohesion: 0.06
Nodes (40): Header, CreateInvoiceDto, LineItemDto, QueryInvoiceDto, toFamilyInvoice(), ArrayMinSize, IsArray, IsDateString (+32 more)
...
Cohesion: 0.15
Nodes (15): GenerateInvoiceDialogProps, FeeDueEntry, FeeDueRow, FeeDuesFilters, feeDuesKeys, feeDuesQueryOptions(), FeeDuesSortBy, FLAGGED_FIELDS (+7 more)
...
Cohesion: 0.12
Nodes (24): subscribeAuthState(), AppShell(), AppShellNavItem, AppShellProps, NavContent(), NavGroupSection(), readGroupCollapsed(), Default (+16 more)
...
Cohesion: 0.06
Nodes (67): balanceOf(), BreakdownCard(), deriveMonthStatus(), FeesHeader(), feesSearchSchema, FeesSummary(), InvoicesCard(), PaymentStatusValue (+59 more)

### Community 47 - "router-integration.test.tsx"
Cohesion: 0.06
Nodes (49): InformationTab(), InformationTabProps, EditGuardianDialogProps, FormState, formatGuardianPhone(), GuardianFilters, GuardiansListPage(), guardiansSearchSchema (+41 more)
...
Cohesion: 0.04
Nodes (70): ApiHideProperty, Global, TeacherClassSection, Column, CreateDateColumn, Entity, JoinColumn, ManyToOne (+62 more)
...
Cohesion: 0.09
Nodes (30): escapeLikePattern(), CreateTeacherDto, CreateUserDto, QueryTeacherDto, QueryUserDto, IsArray, IsDateString, IsEmail (+22 more)
...
Cohesion: 0.15
Nodes (9): decodeMonthOrdinal(), FeeDuesService, GuardianContact, OPEN_STATUSES, sortAggregates(), StudentDueAggregate, StudentDueSnapshot, Injectable (+1 more)
...
Cohesion: 0.11
Nodes (22): GenerateInvoiceDialog(), GlobalSearchEntityResult, GlobalSearchResults, guardianSearchKeys, PaginatedEnvelope, TEACHER_SEARCH_ROLES, TeacherProfile, teacherSearchKeys (+14 more)
...
Cohesion: 0.13
Nodes (21): Calendar(), CalendarProps, DatePickerProps, daysInMonth(), sameDay(), PopoverAnchor(), PopoverAnchorProps, PopoverContentProps (+13 more)
...
Cohesion: 0.06
Nodes (30): InjectQueue, InjectRepository, InjectQueue, InjectRepository, ParsedRow, BulkRowError, ClassSectionLookup, GuardianInput (+22 more)
...
Cohesion: 0.23
Nodes (14): StudentsTab(), StudentSearch(), StudentSearchProps, FeeStructureStudentPicker(), FeeStructureStudentPickerProps, StudentPicker(), StudentPickerProps, FindStudentStep() (+6 more)
...
Cohesion: 0.06
Nodes (53): AllocateStep(), AllocateStepProps, AllocationLine, AllocationSummary, AllocationType, applyLineEdit(), classifyAllocationType(), OutstandingFee (+45 more)
...
Cohesion: 0.03
Nodes (96): ArrayMaxSize, AuditService, RecordAuditEntryInput, Injectable, BulkPreviewSkippedDto, BulkPreviewStudentDto, BulkReminderPreviewResponseDto, QueryReminderBatchesDto (+88 more)
...
Cohesion: 0.33
Nodes (3): AcademicYearService, Injectable, InjectRepository
...
### Community 229 - "@tanstack/react-table"
Cohesion: 0.22
Nodes (7): Default, Disabled, Empty, Invalid, meta, RightToLeft, Story
...
### Community 265 - "error-state.stories.tsx"
Cohesion: 0.33
Nodes (5): CustomRetryLabel, Default, meta, RightToLeft, Story

### Community 270 - "radio.stories.tsx"
Cohesion: 0.11
Nodes (22): UserRole, ROLE_PERMISSIONS, JwtMembership, JwtPayload, LoginResponse, clearPersistedTenant(), getPersistedTenant(), PersistedTenant (+14 more)

### Community 283 - "error-state.stories.tsx"
Cohesion: 0.08
Nodes (23): Default, meta, RightToLeft, Story, Default, meta, Open, Rtl (+15 more)
...
- **Why does `payment()` connect `payments-tab.tsx` to `Payment`, `locale-storage.ts`, `index.ts`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `DiffPanel()` connect `rtl-decorator.tsx` to `smtp-email.provider.ts`?**
