...
## Corpus Check
- 1001 files · ~527,801 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5640 nodes · 15325 edges · 304 communities (226 shown, 78 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 285 edges (avg confidence: 0.74)
...
## Communities (304 total, 78 thin omitted)
...
Cohesion: 0.07
Nodes (40): ApiHideProperty, Column, CreateDateColumn, Entity, Index, JoinColumn, ManyToOne, PrimaryGeneratedColumn (+32 more)

### Community 3 - "Student"
Cohesion: 0.07
Nodes (43): DeleteStudentDialog(), TransferStatusDialog(), TransferStatusDialogProps, AcademicYear, academicYearKeys, AcademicYearListFilters, academicYearQueryOptions(), academicYearsQueryOptions() (+35 more)
...
Cohesion: 0.10
Nodes (29): @nestjs/swagger, ApiTenantAuth(), TestController, requestContext, paginatedSchema(), ContextGuard, resolveRole(), ROLE_PRIORITY (+21 more)

### Community 6 - "StudentService"
Cohesion: 0.17
Nodes (17): TestController, Roles(), CommunicationsController, ApiOkResponse, ApiOperation, ApiTags, Body, Controller (+9 more)

### Community 7 - "routeTree.gen.ts"
Cohesion: 0.04
Nodes (75): Route, Route, Route, Route, Route, Route, Route, Route (+67 more)

### Community 8 - "classes.ts"
Cohesion: 0.06
Nodes (70): JoinTable, AcademicYearStats, InjectRepository, AcademicYear, Column, CreateDateColumn, DeleteDateColumn, Entity (+62 more)

### Community 9 - "School"
Cohesion: 0.10
Nodes (31): BULK_MEDIUMS, BulkMedium, BulkReminderWizard(), RecipientFilters, STEP_IDS, OVERRIDE_MEDIUMS, OverrideMedium, remindersSearchSchema (+23 more)
...
### Community 12 - "Roles"
Cohesion: 0.07
Nodes (24): ApiBody, ApiConsumes, FamilyAccessService, build(), createQueryBuilderStub(), sql(), Injectable, InjectRepository (+16 more)
...
Cohesion: 0.02
Nodes (101): worker, wsPassthrough, auditLogDefaultHandlers, fixtures, list, listByEntity, listByEntityEmpty, listEmpty (+93 more)

### Community 15 - "index.ts"
Cohesion: 0.07
Nodes (41): Header, CurrentTenant, CurrentUser, GenerateFeesResultDto, toFamilyFeeStructure(), toFamilyPayment(), toFamilyStudentDue(), toFamilyStudentFee() (+33 more)
...
Cohesion: 0.09
Nodes (42): CreateFeeStructureDto, CreatePaymentDto, FamilyDueEntryDto, FamilyPaymentAllocationDto, FeeDuesSortBy, GenerateStudentFeesDto, PaymentAllocationInputDto, QueryFeeDuesDto (+34 more)
...
Cohesion: 0.06
Nodes (85): DeleteYearDialogProps, SetCurrentDialogProps, EMPTY_VALUES, YearFormDialogProps, YearFormInitialValues, ClassFormDialog(), ClassFormDialogProps, ClassFormInitialValues (+77 more)

### Community 20 - "students.controller.ts"
Cohesion: 0.13
Nodes (30): SanitizeAllowlist(), SanitizeText(), shared, AllowlistDto, { sanitizeAllowlist, sanitizeStrict }, StrictDto, IsBeforeConstraint, ValidatorConstraint (+22 more)

### Community 21 - "Payment"
Cohesion: 0.05
Nodes (58): Check, FamilyStudentFeeDto, PaymentAllocation, Column, CreateDateColumn, Entity, Index, JoinColumn (+50 more)

### Community 22 - "index.ts"
Cohesion: 0.04
Nodes (46): SchoolSettingsPage(), adminOwnSchool, CONFIGURED_EMAIL, child(), renderPortal(), twoSchools, PaginatedAuditEntries, renderAuditLogs() (+38 more)
...
Cohesion: 0.06
Nodes (70): ChildCard(), daysBetween(), deriveStatus(), MultiChildView(), PortalOverview(), RecentPayments(), SingleStudentView(), summarize() (+62 more)
...
Cohesion: 0.06
Nodes (39): AppShell(), AppShellNavGroup, AppShellProps, NavContent(), NavGroupSection(), readGroupCollapsed(), visibleItems(), ButtonBaseProps (+31 more)
...
Cohesion: 0.06
Nodes (52): LOCALE_LABELS, LocaleSwitcherProps, Menu(), MenuCheckboxItemProps, MenuContent(), MenuContentProps, MenuGroup(), MenuGroupProps (+44 more)
...
Cohesion: 0.07
Nodes (51): ClassesTabProps, FeeStructuresTabProps, TabQueryState(), FeeStructuresTabProps, StudentsTabProps, TabQueryState(), TabQueryStateProps, TeachersTabProps (+43 more)

### Community 32 - "users.controller.ts"
Cohesion: 0.04
Nodes (57): Card(), CardProps, AsLink, Default, meta, RightToLeft, Story, WithSkeletonContent (+49 more)
...
Cohesion: 0.08
Nodes (29): GenerateInvoiceDialogProps, apiClient, BulkUploadError, BulkUploadResult, BulkUploadStudentsInput, useBulkUploadStudents(), FeeDueEntry, FeeDueRow (+21 more)
...
Cohesion: 0.11
Nodes (27): BatchDetail(), batchDetailSearchSchema, buildRetryName(), BulkPreviewSkipped, BulkPreviewStudent, collectFailedStudentIds(), PaginatedReminderBatches, PaginatedReminderBatchLogs (+19 more)

### Community 42 - "index.ts"
Cohesion: 0.09
Nodes (23): Default, Grouped, meta, MobileDrawer, navGroups, navItems, portalNavItems, RightToLeft (+15 more)
...
Cohesion: 0.15
Nodes (25): DiffPanel(), DiffPanelProps, changedFieldCount(), compactJson(), deepEqual(), DiffField, diffFields(), humanizeFieldName() (+17 more)

### Community 47 - "router-integration.test.tsx"
Cohesion: 0.10
Nodes (26): LoginHistoryTab(), LoginHistoryTabProps, ImportErrorTable(), csvCell(), toCsvContent(), minorUnitsToDecimalString(), roundDecimalString(), serverAmountToMinorUnits() (+18 more)
...
Cohesion: 0.06
Nodes (45): escapeLikePattern(), Teacher, Column, CreateDateColumn, DeleteDateColumn, Entity, Index, JoinColumn (+37 more)
...
Cohesion: 0.11
Nodes (22): FormState, GlobalSearchEntityResult, GlobalSearchResults, guardianSearchKeys, PaginatedEnvelope, TEACHER_SEARCH_ROLES, TeacherProfile, teacherSearchKeys (+14 more)
...
Cohesion: 0.06
Nodes (61): SelectSchoolPage(), selectSchoolSearchSchema, UserRole, JwtMembership, JwtPayload, LoginResponse, clearAuthState(), currentSessionGeneration() (+53 more)

### Community 62 - "global-search.tsx"
Cohesion: 0.08
Nodes (36): renderPanel(), EditGuardianDialogProps, GuardianPickerProps, RegionSettings, createI18nInstance(), whenReady(), DocumentLocaleSync(), I18nProvider() (+28 more)
...
Cohesion: 0.07
Nodes (50): StructureFormDialogProps, CreateFeeStructureInput, FeeStructure, feeStructureKeys, FeeStructureListFilters, feeStructureQueryOptions(), feeStructuresQueryOptions(), FeeStructureStudent (+42 more)
...
Cohesion: 0.11
Nodes (26): ChildSummary, CommunicationStatus, CommunicationTrigger, EnrollmentStatus, FeeApplicability, FeeStatus, PaymentAllocationType, PaymentMethod (+18 more)
...
Cohesion: 0.05
Nodes (60): AppShellNavItem, BottomNavProps, Combobox(), ComboboxOption, ComboboxProps, CLASS_OPTIONS, Calendar(), CalendarProps (+52 more)
...
Cohesion: 0.13
Nodes (15): formatGuardianPhone(), GuardianFilters, GuardiansListPage(), guardiansSearchSchema, ProfileTab(), ProfileTabProps, formatStaffPhone(), formatValidPhone() (+7 more)
...
Cohesion: 0.09
Nodes (25): EMPTY_PAGE, PaymentForm(), authDefaultHandlers, login, loginInvalidCredentials, loginRateLimited, loginResponseFactory(), logout (+17 more)
...
Cohesion: 0.06
Nodes (28): InjectQueue, InjectRepository, InjectQueue, InjectRepository, BulkRowError, ClassSectionLookup, GuardianInput, StudentBulkUploadService (+20 more)
...
Cohesion: 0.07
Nodes (34): GlobalSearchLauncher(), StudentSearch(), StudentSearchProps, FeeStructureStudentPicker(), FeeStructureStudentPickerProps, StudentPicker(), StudentPickerProps, FindStudentStep() (+26 more)
...
Cohesion: 0.08
Nodes (40): AllocateStep(), AllocateStepProps, ALLOCATION_TYPE_KEY, AllocationLine, AllocationSummary, AllocationType, applyLineEdit(), classifyAllocationType() (+32 more)
...
Cohesion: 0.20
Nodes (6): RetryableConfig, ApiErrorBody, NoActiveTenantError, RateLimitedError, createAppQueryClient(), handleGlobalQueryError()
...
Cohesion: 0.04
Nodes (47): FailOpenThrottlerStorage, Injectable, buildRateLimitTracker(), AcademicYearModule, Module, TeacherClassSection, Column, CreateDateColumn (+39 more)
...
Cohesion: 0.27
Nodes (9): ACCEPTED_EXTENSIONS, hasAcceptedExtension(), ImportStudentsContent(), ImportStudentsPage(), REQUIRED_COLUMNS, downloadTemplate(), TEMPLATE_EXAMPLE_ROW, TEMPLATE_HEADERS (+1 more)
...
Cohesion: 0.08
Nodes (36): TabQueryStateProps, ClassDetailPage(), TAB_IDS, SectionsTab(), SectionsTabProps, StudentsTab(), SectionsPanel(), InformationTab() (+28 more)
...
Cohesion: 0.06
Nodes (32): Default, meta, RightToLeft, Story, CustomRetryLabel, Default, meta, RightToLeft (+24 more)

### Community 287 - "sms.ts"
Cohesion: 0.22
Nodes (20): getActiveTenant(), clearNotifications(), getNotifications(), getUnreadNotificationCount(), lastSeenTenantId, listeners, markAllNotificationsRead(), markNotificationRead() (+12 more)

### Community 298 - "tenant-provider-config.resolver.spec.ts"
Cohesion: 0.53
Nodes (4): fakeCache(), fakeConfig(), fakeSchools(), resolverWith()

### Community 306 - "single-reminder.service.spec.ts"
Cohesion: 0.24
...
## Knowledge Gaps
- **1382 isolated node(s):** `semi`, `singleQuote`, `trailingComma`, `printWidth`, `prettier-plugin-tailwindcss` (+1377 more)
...
- **Why does `DiffPanel()` connect `locale-storage.ts` to `date-picker.tsx`, `global-search.tsx`?**
  _High betweenness centrality (0.122) - this node is a cross-community bridge._
- **Why does `buildXlsxFile()` connect `date-picker.tsx` to `classes.ts`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
- **Why does `AccessTokenDenylistService` connect `index.tsx` to `communications.controller.ts`, `validation-pipe.spec.ts`, `locale-storage.ts`?**
