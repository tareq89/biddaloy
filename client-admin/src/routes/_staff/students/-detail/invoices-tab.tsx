 ...
 * HTML blob opened in a new tab instead of downloaded. */
async function openPrintableInvoice(invoiceId: string): Promise<void> {
                ...
                <TableRow key={invoice.id}>
                  ...
                  <TableCell>
                    <Button
                      ...
                      onClick={() => void openPrintableInvoice(invoice.id)}
                    >
