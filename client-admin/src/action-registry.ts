...
export const ACTIONS: readonly PaletteAction[] = [
  {
    ...
    run: (ctx) => ctx.navigate({ to: '/_staff/payments/record' }),
  },
  {
    ...
    run: (ctx) => ctx.navigate({ to: '/_staff/communications/send' }),
  },
  {
    ...
    kind: 'navigate',
    run: (ctx) => ctx.navigate({ to: '/_staff/communications/reminders' }),
  },
  {
    id: 'attendance.take',
    ...
    kind: 'navigate',
    run: (ctx) => ctx.navigate({ to: '/_staff/attendance/' }),
  },
  {
    id: 'fees.generate',
    ...
    kind: 'modal',
    run: (ctx) => ctx.navigate({ to: '/_staff/fees/generate' }),
  },
  {
    id: 'students.add',
    ...
    kind: 'modal',
    run: (ctx) => ctx.navigate({ to: '/_staff/students/new' }),
  },
  {
    id: 'students.import',
    ...
    kind: 'navigate',
    run: (ctx) => ctx.navigate({ to: '/_staff/students/import' }),
  },
];
