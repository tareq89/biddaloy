...
flowchart LR
    ...
    GN -->|diff fails| CI
    GC -->|diff fails| CI
    A[action-registry.ts] --> GA["shape guard (planned)"]
...
| `route-crumbs.ts` + `route-crumbs.test.ts`                                                                | Every route has a breadcrumb label                                                                                                                                                                                                                                                           | `route-crumbs.test.ts` fails: `route(s) missing ROUTE_CRUMBS entry: /_staff/reports/new`                                                                                                                                                                                                                                             |
