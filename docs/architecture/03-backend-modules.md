...
| `exams`          | `Exam`, `ExamComponent`, `MarkGrid`, `Mark`, `Result`, `ResultSubject`, `StudentSubjectChoice` (Epic 19.0) — see [01-domain-model.md](01-domain-model.md#exams-marks--results-modulesexams--epic-190) | `POST/GET/PATCH exams`, `POST/GET/PATCH exams/:id/components`, `GET/PATCH exams/:id/marks`, `POST exams/:id/marks/submit`\|`reopen`, `GET exams/:id/marks/progress`, `GET exams/:id/results`, `POST exams/:id/results/process`\|`publish`\|`reopen`\|`sms`, `GET students/:id/results` |
