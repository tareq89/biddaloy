...
| [10-third-party-services.md](10-third-party-services.md) | Need to know what external services/APIs Biddaloy depends on (Postgres, Redis, BullMQ, S3/MinIO object storage, SMS/WhatsApp/email providers, Sentry) — and what it deliberately doesn't use (no payment gateway) |
