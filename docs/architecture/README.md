...
| [10-third-party-services.md](10-third-party-services.md) | Need to know what external services/APIs Biddaloy depends on (Postgres, Redis, BullMQ, SMS/WhatsApp/email providers, Sentry, S3-compatible object storage) — and what it deliberately doesn't use (no payment gateway) |
