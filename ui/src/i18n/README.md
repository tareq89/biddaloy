...
Both locale files need the key — `yarn workspace @beton-boi/ui check:i18n`
...
4. `yarn workspace @beton-boi/ui check:i18n` locally (or the CI job) is
...
```bash
yarn workspace @beton-boi/ui check:i18n
```
